...
class ActivityModeShare(PlanHandlerTool):
    """
...
class PlanHandlerWorkStation(WorkStation):
    ...
    tools = {
        ...
        "trip_destination_mode_share": ActivityModeShare,
        "activity_mode_share": ActivityModeShare,  # preferred name
        "leg_logs": LegLogs,
        "trip_logs": TripLogs,
        "plan_logs": PlanLogs,
